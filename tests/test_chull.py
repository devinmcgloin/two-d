from twod.primitives import Point
...
def test_chull():
    points = [Point(0.0,0.0), Point(0.0,1.0), Point(1.0,1.0), Point(1.0,0.0), Point(0.5,0.5)]
    assert len(convex_hull(points)) == 4

    points = [Point(1.0, 0.0), Point(2.0, 0.0), Point(1.0, 2.0), Point(0.0, 1.0)]
    ...
    actual_hull = convex_hull(points)
